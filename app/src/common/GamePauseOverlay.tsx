    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          padding: '8px 0', borderTop: `1px solid ${col}22`, borderBottom: `1px solid ${col}22`,
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontFamily: 'monospace', fontSize: 9, color: C.text, opacity: 0.5 }}>Score</span>
            <span style={{ fontFamily: 'monospace', fontSize: 11, fontWeight: 700, color: C.white }}>{score.toLocaleString()}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontFamily: 'monospace', fontSize: 9, color: C.text, opacity: 0.5 }}>Speed</span>
            <span style={{ fontFamily: 'monospace', fontSize: 11, fontWeight: 700, color: C.white }}>{speedBand}</span>
          </div>
        </div>
